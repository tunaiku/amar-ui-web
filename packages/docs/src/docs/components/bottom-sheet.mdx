...
Similar to a dialog, it has an interruptive nature and covers the front of the primary content until
dismissed or confirmed when called. Use bottom sheet to diver's user's attention on an important
information in a more detailed fashion that a standard dialog lacks."
---
