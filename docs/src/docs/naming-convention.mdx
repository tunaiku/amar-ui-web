...
description: 'Our naming convention is highly influenced and adapted from SUIT CSS.'
---

## Principles

Strictly adhere to the agreed-upon style guide listed below. The general principle is to develop
**DRY (Don't Repeat Yourself)** SCSS, built around reusable components and patterns.
